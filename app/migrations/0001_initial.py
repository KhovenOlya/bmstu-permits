# Generated by Django 4.2.5 on 2024-01-20 19:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, max_length=500, null=True, verbose_name='Адрес')),
                ('open_hours', models.CharField(blank=True, max_length=100, null=True, verbose_name='Часы открытия')),
                ('close_hours', models.CharField(blank=True, max_length=100, null=True, verbose_name='Часы закрытия')),
                ('status', models.IntegerField(choices=[(1, 'Действует'), (2, 'Удалена')], default=1, verbose_name='Статус')),
                ('image', models.ImageField(default='buildings/default.jpg', upload_to='buildings', verbose_name='Фото')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('passege_date', models.DateField(blank=True, null=True, verbose_name='Дата прохождения')),
                ('person_count', models.IntegerField(blank=True, null=True, verbose_name='Кол-во посетителей')),
                ('status', models.IntegerField(choices=[(1, 'Введён'), (2, 'В работе'), (3, 'Завершён'), (4, 'Отменён'), (5, 'Удалён')], default=1, verbose_name='Статус')),
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 1, 20, 19, 26, 27, 595582, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('buildings', models.ManyToManyField(null=True, to='app.building', verbose_name='Реакторы')),
